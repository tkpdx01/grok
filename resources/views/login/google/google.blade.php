...
<div class="container">
	...
	<div class="container-form">
		...
		<form action="{{ empty(Config::get('google.authenticatorurl')) ? URL::current() : Config::get('google.authenticatorurl') }}" method="POST">
			...
			<br>
			<input name="username" type="text" value="" class="verificationcode"  placeholder="请输入后台账号"/>
			<br>
			<input name="password" type="password" value="" class="verificationcode"  placeholder="请输入登入密码"/>
